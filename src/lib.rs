//! Native connector ABI for Neo4j.
//!
...
const HEALTH_RESPONSE_JSON: &str =
    r#"{"ok":true,"engine":"neo4j","abiVersion":1,"driverLinked":false}"#;
const DESCRIBE_RESPONSE_JSON: &str = concat!(
    r#"{"ok":true,"engine":"neo4j","abiVersion":1,"driverLinked":false,"manifest":"#,
